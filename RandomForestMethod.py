def build_model_forest(dataset_path, features_list, target, max_leaf_nodes, max_depth=None):
    import pandas as pd
    ...
    rf_model1 = RandomForestRegressor(max_depth=max_depth)
    ...
    rf_model2 = RandomForestRegressor(max_depth=max_depth, max_leaf_nodes=max_leaf_nodes)
